...
<center>Nyquist Criterion: f<sub>s</sub> > 2f<sub>max</sub></center>
...
<center>-A + D/2 + D .* (0, 1, 2, ..., q-1)</center>
...
<center>P = sum( |x|<sup>2</sup> )</center>
...
<center>SQNR = P<sub>s</sub> / P<sub>n</sub></center>
<center>SQNR<sub>dB</sub> = 10Log<sub>10</sub>(SQNR)</center>

In DSP literature it is common to estimate the SQNR of a quantized full-scale sine wave as:

<center>SQNR<sub>dB</sub> = 1.76 + 6.02*b [dB]</center>
